...
class Projects extends Component {
    render() {
        return (
            <section id='work'>
                <h2 class='side-header'>Work Portfolio</h2>
                <div class='portfolio-container'>
                    {/* <a href='https://jakech617.github.io/beatzilla/' class='fade' id='proj1' type='_blank' style='background-image: url(./Assets/images/Project1.PNG)' alt='screenshot of project'><p>Group Project - Beatzilla</p></a>
